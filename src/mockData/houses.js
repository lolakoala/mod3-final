const houses = [
  {
    ...
    region: '',
    coatOfArms:
      'Three black ravens in flight, holding three red hearts.',
    words: '',
  ...
  },
  {
    ...
    region: 'The Vale',
    coatOfArms:
      'Black iron studs on a bronze field, bordered with runes.',
    words: 'We Remember',
    titles: [
    ...
    cadetBranches: ['https://www.anapioficeandfire.com/api/houses/329'],
    swornMembers: [
  ...
  },
  {
    ...
    cadetBranches: ['https://www.anapioficeandfire.com/api/houses/23'],
    swornMembers: [
